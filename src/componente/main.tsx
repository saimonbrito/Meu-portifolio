            ...
            ">
                ...
                <div className='flex fle justify-between items-center'> 
                    <div className='flex flex-col gap-4'>
                       <strong><a href="https://www.linkedin.com/in/mauricio-fernandes-8393071a6/" ><img src={In} width={40} alt="" /></a></strong>
                       <strong><a href="https://github.com/saimonbrito"><img src={Git} width={40} alt="" /> </a></strong>
                       <strong><a href="*"><img src={zap} width={40} alt="" /></a></strong>
                       <strong></strong>
                    </div>
